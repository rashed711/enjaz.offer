...
const App: React.FC = () => {
  ...
  const [quotation, setQuotation] = useState<QuotationData>({
    ...
    items: [
      {
        ...
        description: "تسجيل انطاق الرسمي للشركة SmartSource-eg.com",
        duration: "سنة واحدة",
        cost: 850
      }
      ...
      {
        id: "2",
        name: "استضافة بريد إلكتروني للأعمال",
        description: "إعداد وتفعيل لوحة تحكم خاصة بالعميل لإدارة البريد الإلكتروني (مساحة التخزين 5 جيجا).",
        duration: "سنة واحدة",
        cost: 2000
      }
    ],
    vatRate: 0,
    terms: [
      "تلتزم شركة إنجاز بتقديم الدعم الفني مجاناً لمدة 12 أشهر.",
      "تلتزم شركة إنجاز بإتاحة نقل الدومين عند الطلب وفق سياسات الجهة المسجِّلة.",
      "طريقة الدفع: السداد كاملا بعد الإنتهاء من الإعداد والتشغيل"
    ]
  });
